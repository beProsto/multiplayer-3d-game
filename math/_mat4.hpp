...
namespace Math {
	namespace _Mat4 {
		...
		void Multiply(float* _mat, const float* _a, const float* _b) {
			...
			_mat[0] = b0 * a0 + b1 * a4 + b2 * a8 + b3 * a12;
			_mat[1] = b0 * a1 + b1 * a5 + b2 * a9 + b3 * a13;
			_mat[2] = b0 * a2 + b1 * a6 + b2 * a10 + b3 * a14;
			_mat[3] = b0 * a3 + b1 * a7 + b2 * a11 + b3 * a15;
			...
			_mat[4] = b0 * a0 + b1 * a4 + b2 * a8 + b3 * a12;
			_mat[5] = b0 * a1 + b1 * a5 + b2 * a9 + b3 * a13;
			_mat[6] = b0 * a2 + b1 * a6 + b2 * a10 + b3 * a14;
			_mat[7] = b0 * a3 + b1 * a7 + b2 * a11 + b3 * a15;
			...
			_mat[8] = b0 * a0 + b1 * a4 + b2 * a8 + b3 * a12;
			_mat[9] = b0 * a1 + b1 * a5 + b2 * a9 + b3 * a13;
			_mat[10] = b0 * a2 + b1 * a6 + b2 * a10 + b3 * a14;
			_mat[11] = b0 * a3 + b1 * a7 + b2 * a11 + b3 * a15;
			...
			_mat[12] = b0 * a0 + b1 * a4 + b2 * a8 + b3 * a12;
			_mat[13] = b0 * a1 + b1 * a5 + b2 * a9 + b3 * a13;
